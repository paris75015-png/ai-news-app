...
// Gemini がすべて使えなかった記事の要約に使う予備（Groq の無料枠。GROQ_API_KEY があるときだけ使う）
...
export const CATEGORIES = [
  ...
  { id: 'economy', label: '経済', desc: '企業業績・産業・景気・物価・雇用・貿易・経済政策' },
  { id: 'finance', label: '金融', desc: '株式・為替・金利・中央銀行・銀行・投資・暗号資産' },
