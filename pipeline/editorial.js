...
export const EDITORIAL_VERSION = 11;
...
- 一次性：当事者の公式発表や独自取材か。まとめ記事・宣伝記事は低くする。
  ただし**名前のある当事者どうしの主張の対立を具体的に整理した記事は下げない**（論評だからという理由で下げない）
...
# 中身のない見出しを作らない（厳守）
「〜をめぐる議論と業界の動向」「〜の最新状況」「〜に関する取り組み」のような、
何が起きたのか分からない見出しは禁止する。**誰が・何を・どうしたのかを必ず入れる。**
対立を扱う記事なら、対立している当事者の名前を入れる。
（悪い例：「人工知能の安全性と規制をめぐる議論と業界の動向」
　良い例：「AI減速論でアモデイらと対立、エヌビディア黄氏は規制不要と主張」）
